...
public class CVApplication extends PackagesResourceConfig {
    ...
    public void activate() {
        try {
            ...
            httpService.registerServlet(CV_SERVLET_ALIAS, new AtmosphereServlet(), getJerseyServletParams(),
                    createHttpContext());
    ...
    private Dictionary<String, String> getJerseyServletParams() {
        ...
        final String[] interceptors = { "org.atmosphere.interceptor.CacheHeadersInterceptor",
                ...
                "org.atmosphere.interceptor.JavaScriptProtocol", "org.atmosphere.interceptor.OnDisconnectInterceptor" };
        ...
        // the other advantage of this solution is, that the BroadcasterCache class does not need to be exported by this
        // package
        // jerseyServletParams.put("org.atmosphere.cpr.broadcasterCacheClass",
        // "org.openhab.io.cv.internal.cache.CVBroadcasterCache");
