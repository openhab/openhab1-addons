 ...
 * for using openHAB Cloud functionality.
 *
 * @author Victor Belov
 * @since 1.3.0
 */
public class CloudService {
    ...
    static NotificationAction notificationAction = null;

    /**
     * Sends a simple push notification to mobile devices of user
     * 
     * @param userId the openHAB Cloud user id of the recipient
    ...
    static public void sendNotification(String userId, String message, String icon, String severity) {
        ...
        if (notificationAction != null) {
            notificationAction.sendNotification(userId, message, icon, severity);
        }
    }
    ...
    static public void sendLogNotification(String message, String icon, String severity) {
        if (notificationAction != null) {
            notificationAction.sendLogNotification(message, icon, severity);
        }
    }
    ...
    static public void sendBroadcastNotification(String message, String icon, String severity) {
        if (notificationAction != null) {
            notificationAction.sendBroadcastNotification(message, icon, severity);
        }
    }
