...
/**
 * This interface allows guice-enabled classes to have access to the item registry
 ...
 *
 */
@ImplementedBy(value = ItemRegistryProvider.class)
public interface IItemRegistryProvider {
