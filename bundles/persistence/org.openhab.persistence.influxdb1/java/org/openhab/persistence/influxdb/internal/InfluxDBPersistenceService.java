 ...
 * 
 * @author Theo Weiss - Initial Contribution, rewritten for influxdb > 0.9 support
...
public class InfluxDBPersistenceService implements QueryablePersistenceService, ManagedService {
    ...
    if (! connected) {
      ...
      try {
        ...
        if (version != null && !version.contains("unknown")) {
          ...
          logger.error("database connection failed, version is: \"{}\" response time was \"{}\"",
  ...
  public Iterable<HistoricItem> query(FilterCriteria filter) {
    ...
    // InfluxDB returns results in DESCENDING order by default: TODO this has changed for 0.9?
