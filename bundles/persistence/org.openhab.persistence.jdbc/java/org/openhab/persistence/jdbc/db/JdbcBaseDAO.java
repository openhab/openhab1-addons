...
public class JdbcBaseDAO {
	...
	private void initSqlQueries() {
		...
		//hsqldb    SQL_IF_TABLE_EXISTS                      = "SELECT * FROM INFORMATION_SCHEMA.SYSTEM_TABLES WHERE TABLE_NAME='#searchTable#'";
		//hsqldb    SQL_IF_TABLE_EXISTS                      = "SELECT * FROM INFORMATION_SCHEMA.SYSTEM_TABLES WHERE TABLE_NAME='#searchTable#'";
	...
	public Long doCreateNewEntryInItemsTable(ItemsVO vo) {
		String sql = StringUtilsExt.replaceArrayMerge(
				SQL_CREATE_NEW_ENTRY_IN_ITEMS_TABLE, 
	...
	public void doDeleteItemsEntry(ItemsVO vo) {
		String sql = StringUtilsExt.replaceArrayMerge(
				SQL_DELETE_ITEMS_ENTRY, 
				new String[]{ "#itemname#"}, new String[]{vo.getItemname()}
				);
	...
	public List<ItemsVO> doGetItemIDTableNames(ItemsVO vo) {
		String sql = StringUtilsExt.replaceArrayMerge(
				SQL_GET_ITEMID_TABLE_NAMES, 
				new String[]{ "#itemsManageTable#"}, 
				new String[]{ vo.getItemsManageTable()}
				);
	...
	protected ItemVO storeItemValueProvider(Item item, ItemVO vo) {
		...
		logger.debug("JDBC::storeItemValueProvider: item '{}' as Type '{}' in '{}' with state '{}'", 
				item.getName(), 
				itemType,
				vo.getTableName(), 
	...
	public String getItemType(Item i) {
		...
		if (sqlTypes.get(itemType) == null) {
			logger.warn("JDBC::getItemType: No sqlType found for ItemType {}, use ItemType for STRINGITEM as Fallback for {}",
					itemType, i.getName());
			return def;
		}
		return itemType;
