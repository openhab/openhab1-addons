...
public class JdbcPostgresqlDAO extends JdbcBaseDAO{
	...
	private void initSqlQueries() {
		...
		//SQL_INSERT_ITEM_VALUE               = "INSERT INTO #tableName# (TIME, VALUE) VALUES( NOW(), CAST( ? as #dbType#) ) ON CONFLICT DO NOTHING";
	...
	private void initSqlTypes() {
		...
		logger.debug("JDBC::initPostgreSqlTypes: Initialize the type array sqlTypes={}", sqlTypes.values());
	}
