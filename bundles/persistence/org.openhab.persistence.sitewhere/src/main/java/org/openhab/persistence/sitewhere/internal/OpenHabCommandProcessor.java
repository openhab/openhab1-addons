...
public class OpenHabCommandProcessor extends BaseCommandProcessor {
     ...
     */
    @Override
    public void executeStartupLogic(String hardwareId, String specificationToken, ISiteWhereEventDispatcher dispatcher)
     ...
     * @param command
     */
    public void sendOnOffCommand(String itemName, String command, IDeviceEventOriginator originator) {
        LOGGER.debug("Received On/Off command for: " + itemName + " (" + command + ")");
     ...
     * @param command
     */
    public void sendOpenCloseCommand(String itemName, String command, IDeviceEventOriginator originator) {
        LOGGER.debug("Received Open/Close command for: " + itemName + " (" + command + ")");
