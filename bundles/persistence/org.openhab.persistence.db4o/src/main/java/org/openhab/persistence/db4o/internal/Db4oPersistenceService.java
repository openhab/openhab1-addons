...
import static org.openhab.persistence.db4o.internal.Db4oConfiguration.*;
...
public class Db4oPersistenceService implements QueryablePersistenceService {
    ...
    public static class BackupJob implements Job {
        ...
        public void execute(JobExecutionContext context) throws JobExecutionException {
            long startTime = System.currentTimeMillis();
            String backupFileName = DB_FOLDER + File.separator + DATE_FORMATTER.format(System.currentTimeMillis()) + "_"
                    + DB_FILE_NAME + ".bak";
            ...
            try {
                ...
                if (!extDb.isClosed()) {
                    ...
                    logger.debug("successfully created new DB4O backup '{}' in {}ms", backupFileName,
