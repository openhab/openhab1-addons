...
package org.openhab.binding.knx.core.internal.config;
...
import org.openhab.binding.knx.core.internal.dpt.KNXCoreTypeMapper;
...
public class KNXGenericBindingReader implements BindingConfigReader, KNXBindingProvider {
	 ...
	 * from this source
	 */
	private Map<Item, Collection<BindingConfig>> bindingConfigs = new WeakHashMap<Item, Collection<BindingConfig>>();
