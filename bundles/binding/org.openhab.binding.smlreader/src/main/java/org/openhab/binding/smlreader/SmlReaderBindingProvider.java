...
public interface SmlReaderBindingProvider extends BindingProvider {
	...
	/**
	 * Returns the TransformationService-type of the Item identified by {@code itemName}
	 * 
	 * @param itemName
	 *            the name of the item to find the type for
	 * @return the TransformationService-type of the Item identified by {@code itemName}
	 */
	public String getTransformationType(String itemName);

	/**
	 * Returns the TransformationService-function of the Item identified by {@code itemName}
	 * 
	 * @param itemName
	 *            the name of the item to find the function for
	 * @return the TransformationService-function of the Item identified by {@code itemName}
	 */
