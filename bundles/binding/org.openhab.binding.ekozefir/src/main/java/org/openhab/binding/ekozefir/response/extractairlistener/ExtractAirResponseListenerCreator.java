 ...
 */
package org.openhab.binding.ekozefir.response.extractairlistener;
...
/**
 * Creator for extract air response listener. Listen for response from ahu.
 * 
 * @author Michal Marasz
 * @since 1.6.0
 *
 */
public class ExtractAirResponseListenerCreator implements ResponseListenerCreator {
	...
	public ResponseListener create(final String item, final EventPublisher publisher) {
		...
		return new ResponseListener() {
			private final int byteNumberOfResponse = 5;
