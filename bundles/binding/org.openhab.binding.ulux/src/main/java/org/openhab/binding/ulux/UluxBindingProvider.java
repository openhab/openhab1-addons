...
/**
 * This interface is implemented by classes that can provide mapping information between openHAB items and a u::Lux
 * switch.
 * 
...
public interface UluxBindingProvider extends BindingProvider {
	...
	UluxBindingConfig getBinding(String itemName);
