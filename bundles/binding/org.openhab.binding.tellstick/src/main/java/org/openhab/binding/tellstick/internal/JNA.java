...
public class JNA {
    public enum Method {
        TURNON(CLibrary.TELLSTICK_TURNON),
        TURNOFF(CLibrary.TELLSTICK_TURNOFF),
        DIM(CLibrary.TELLSTICK_DIM),
        LEARN(CLibrary.TELLSTICK_LEARN),
        DEVICE_ADDED(CLibrary.TELLSTICK_DEVICE_ADDED),
        DEVICE_CHANGED(CLibrary.TELLSTICK_DEVICE_CHANGED),
    ...
    public enum DataType {
        ...
        WINDAVERAGE(CLibrary.TELLSTICK_WINDAVERAGE),
        WINDDIRECTION(CLibrary.TELLSTICK_WINDDIRECTION),
        WINDGUST(CLibrary.TELLSTICK_WINDGUST),
        RAINRATE(CLibrary.TELLSTICK_RAINRATE),
        RAINTOTAL(CLibrary.TELLSTICK_RAINTOTAL);
