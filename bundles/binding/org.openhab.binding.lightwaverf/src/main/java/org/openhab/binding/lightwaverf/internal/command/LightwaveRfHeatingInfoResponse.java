...
public class LightwaveRfHeatingInfoResponse implements LightwaveRfSerialMessage {
	...
	public LightwaveRfHeatingInfoResponse(String message) {
		...
		output = Integer.valueOf(getStringFromText(OUTPUT_TEMP_REG_EXP, message));
	...
	public String getLightwaveRfCommandString() {
		return new StringBuilder("*!{")
			...
			.append("\",\"batt\":").append(batteryLevel)
			.append(",\"ver\":").append(version)
			.append(",\"state\":\"").append(state)
			.append("\",\"cTemp\":").append(currentTemperature)
			.append(",\"cTarg\":").append(currentTargetTemperature)
			.append(",\"output\":").append(output)
			.append(",\"nTarg\":").append(nextTargetTeperature)
