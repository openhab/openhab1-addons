 ...
 * @since 1.4.0
 */
public class PioneerAvrGenericBindingProvider extends AbstractGenericBindingProvider
        implements PioneerAvrBindingProvider {
    ...
    protected void parseBindingConfig(String bindingConfigs, PioneerAvrBindingConfig config)
            throws BindingConfigParseException {
        ...
        if (configParts.length != 3) {
            throw new BindingConfigParseException("pioneerav binding must contain three parts separated by ':'");
        }
