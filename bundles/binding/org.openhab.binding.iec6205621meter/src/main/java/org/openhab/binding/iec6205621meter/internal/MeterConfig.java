...
public class MeterConfig {
    ...
    public MeterConfig(String serialPort, int baudRateChangeDelay, boolean echoHandling) {
    ...
    public String toString() {
        return "IEC 62056-21Meter DeviceConfig [serialPort=" + serialPort + ", baudRateChangeDelay="
                + baudRateChangeDelay + ", echoHandling=" + echoHandling + "]";
    }
