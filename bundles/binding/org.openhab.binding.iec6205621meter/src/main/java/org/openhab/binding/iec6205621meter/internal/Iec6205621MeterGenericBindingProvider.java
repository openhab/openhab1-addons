 ...
 * @since 1.5.0
 */
public class Iec6205621MeterGenericBindingProvider extends AbstractGenericBindingProvider
        implements Iec6205621MeterBindingProvider {
    ...
    public String getObis(String itemName) {
        Iec6205621MeterBindingConfig config = (Iec6205621MeterBindingConfig) bindingConfigs.get(itemName);
