...
public class SerialParameterValidator {
	public static final Integer[] COMMON_BAUD_RATES = { 75, 110, 300, 1200,
	...
	public static final Integer[] VALID_PARITYS = { SerialPort.PARITY_NONE,
	...
	public static final String[] VALID_FLOWCONTROL_STRINGS = { "none",
			"xon/xoff out", "xon/xoff in", "rts/cts in", "rts/cts out" };
	...
	public static final Integer[] VALID_FLOWCONTROL_INT = { 0, (1 << 0),
			(1 << 1), (1 << 2), (1 << 3) }; 
