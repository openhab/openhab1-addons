...
public class NibeHeatPumpDataParser {
	...
	Collections.unmodifiableMap(new HashMap<Integer, VariableInformation>() {{
		...
		put(40141, new VariableInformation(10,	"AZ2-BT22 Supply air temp. SAM",				NibeDataType.S16,	Type.Sensor));		// Unit: ºC
		put(40142, new VariableInformation(10,	"AZ2-BT23 Outdoor temp. SAM",					NibeDataType.S16,	Type.Sensor));		// Unit: ºC
...
//		put(43141, new VariableInformation(1,	"compr. in power",								NibeDataType.U16,	Type.Sensor));		// Unit: W
		...
		put(43542, new VariableInformation(10,	"Calculated supply air temp.",					NibeDataType.S16,	Type.Sensor));		// Unit: ºC
