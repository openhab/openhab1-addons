...
public class WemoGenericBindingProvider extends AbstractGenericBindingProvider implements WemoBindingProvider {
	...
	/**
	 * Return the specified channel type for the given <code>itemName</code> if
	...
	public enum WemoChannelType {
		state, lastChangedAt, lastOnFor, onToday, onTotal, timespan, averagePower, currentPower, energyToday, energyTotal, standbyLimit
	}
}
