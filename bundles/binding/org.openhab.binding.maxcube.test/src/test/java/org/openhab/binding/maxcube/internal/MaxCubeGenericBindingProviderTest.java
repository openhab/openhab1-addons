...
//import org.openhab.binding.maxcube.internal.HttpGenericBindingProvider.HttpBindingConfig;
 ...
 * @since 1.3.0
 */
public class MaxCubeGenericBindingProviderTest {
	
	private MaxCubeGenericBindingProvider provider;
	private Item testItem;
	
	@Before
	public void init() {
		provider = new MaxCubeGenericBindingProvider();
