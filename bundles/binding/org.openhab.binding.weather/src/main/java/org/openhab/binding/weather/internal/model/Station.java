...
public class Station {
    @ProviderMappings({@Provider(name = ProviderName.WUNDERGROUND,property = "current_observation.observation_location.full")
    ...
    private String id;
    @ProviderMappings({@Provider(name = ProviderName.WUNDERGROUND,property = "current_observation.observation_location.latitude")
    ...
    @ProviderMappings({@Provider(name = ProviderName.WUNDERGROUND,property = "current_observation.observation_location.longitude")
    ...
    @ProviderMappings({@Provider(name = ProviderName.WUNDERGROUND,property = "current_observation.observation_location.elevation",converter = ConverterType.FEET)
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).append("name",
            name).append("id", id).append("latitude", latitude)
                                                                          .append("longitude",
            longitude).append("altitude", altitude).toString();
    }
}
