 ...
 * @since 1.4.0
 */
public class StiebelHeatPumpSimulator extends StiebelHeatPumpConnector {

	private static final Logger logger = LoggerFactory.getLogger(StiebelHeatPumpSimulator.class);

	public StiebelHeatPumpSimulator() {
		logger.debug("Stiebel heatpump Test message listener started");
	}
	...
	public byte[] receiveDatagram() throws StiebelHeatPumpException {
		try {
			...
			throw new StiebelHeatPumpException(e);
		}
	}
