...
public class ConfigParserTest {
	...
	public List<Request> getHeatPumpConfiguration() {
		...
		Request settingsHeatingProgram = new Request("SettingsHeatingProgram", "Read heating program 1 and 2 setting values",
				(byte) 0x0b);
		...
		Request settingsDomesticWaterProgram = new Request("SettingsDomesticHotWaterProgram", "Read Domestic Water program setting values",
				(byte) 0x0c);
		...
		Request settingsVentilationProgram = new Request("SettingsVentilationProgram", "Read ventilation program 1 and 2 setting values",
				(byte) 0x0d);
		...
		Request settingsRestartTime = new Request("SettingsRestartAndMixerTime", "Read restart and mixer time setting values",
				(byte) 0x0a);
