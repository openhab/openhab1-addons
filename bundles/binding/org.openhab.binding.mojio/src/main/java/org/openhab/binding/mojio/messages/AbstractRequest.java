...
public abstract class AbstractRequest extends AbstractMessage implements Request {
	...
	protected static final String API_BASE_URL = "https://api.moj.io:443/";
	...
	static {
		...
		HTTP_HEADERS.put("User-Agent", "mojio-openhab-api/1.0");
	...
	protected final RuntimeException newException(final String message, final Exception cause, final String url,
		...
		if (cause instanceof JsonMappingException) {
			return new MojioException("Could not parse JSON from URL '" + url + "': " + json, cause);
		}

		return new MojioException(message, cause);
	}
}
