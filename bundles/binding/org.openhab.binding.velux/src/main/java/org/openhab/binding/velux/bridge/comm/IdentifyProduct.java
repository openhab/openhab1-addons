 ...
 */
public abstract class IdentifyProduct implements BridgeCommunicationProtocol  {
 
    public IdentifyProduct setProductId(int id) {
    	return this;
    	}

}
/**
 * end-of-bridge/comm/IdentfifyProduct.java
 */
