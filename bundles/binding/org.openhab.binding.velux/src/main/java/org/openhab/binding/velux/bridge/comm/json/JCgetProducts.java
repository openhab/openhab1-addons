...
public class JCgetProducts extends GetProducts implements JsonBridgeCommunicationProtocol {
	...
	private static String description = "get Products";
	...
	/**
	 * ===========================================================
	 * <P>Public Methods required for abstract class {@link org.openhab.binding.velux.bridge.comm.GetScenes}.
	 */
	@Override
	public VeluxProduct[] getProducts() {
		...
		for (int productIdx = 0; productIdx < response.data.length; productIdx++) {
			products[productIdx] = new VeluxProduct(
					new VeluxProductName(response.data[productIdx].name),
...
/**
 * end-of-bridge/comm/json/BCgetProducts.java
 */
