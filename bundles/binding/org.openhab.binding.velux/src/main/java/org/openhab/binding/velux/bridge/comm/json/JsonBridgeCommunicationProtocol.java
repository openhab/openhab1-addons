 ...
 * <P>
 * This bridge communication is an extension of the common {@link org.openhab.binding.velux.bridge.comm.BridgeCommunicationProtocol BridgeCommunicationProtocol}.
 * <P>
 * Message semantic will be defined by the implementation of the separate message classes,
 * which are defined within {@link org.openhab.binding.velux.bridge.comm.json.JsonBridgeAPI JsonBridgeAPI}.
 * <P>
 * The implementations will define the informations which to send query and receive answer
 * through the
 ...
 * <LI>{@link #getClassOfResponse} to retrieve the class of the object of response message for further JSON deserialization.</LI>
...
public interface JsonBridgeCommunicationProtocol extends BridgeCommunicationProtocol {
	 ...
	 *
	 * @param response
	 *         is the appropriate object of previously given class Object.
	 */
