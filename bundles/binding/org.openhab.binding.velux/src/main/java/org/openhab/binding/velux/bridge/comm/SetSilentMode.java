 ...
 */
public abstract class SetSilentMode implements BridgeCommunicationProtocol  {
 
    public SetSilentMode setMode(int id, boolean silent) {
    	return this;
    	}

}
/**
 * end-of-bridge/comm/SilentMode.java
 */
