...
public class Packet  {
	...
	/**
	 * Constructor: Create a {@link org.openhab.binding.velux.bridge.comm.slip.Packet Packet} out of a sequence of bytes.
	...
	/**
	 * Returns the length of the {@link org.openhab.binding.velux.bridge.comm.slip.Packet Packet}..
	 *
	...
	/**
	 * Returns the complete {@link org.openhab.binding.velux.bridge.comm.slip.Packet Packet} as sequence of bytes.
	 *
	 * @return <b>packet</b>
	...
	/**
	 * Returns a part of the {@link org.openhab.binding.velux.bridge.comm.slip.Packet Packet} as sequence of bytes
	 * starting at position (n) up to the position (n+length-1).
	 * @param position
	 * 			Position (n) within the packet.
	 * @param length
	 * 			Length of the intended slice as int.
	 * @return <b>packet</b>
	 *         of type Array-of-byte.
	 */
	public byte[] getByteArray(int position, int length)  {
		return Arrays.copyOfRange(data, position, position+length-1);
	}

	/**
	 * Returns the complete {@link org.openhab.binding.velux.bridge.comm.slip.Packet Packet} 
	 * as human-readable sequence of hex bytes each separated by the given separator.
	 * 
	 * @param separator		as of Type String. 
	 *
	 * @return <b>packetString</b>
	 *         of type String.
	 */
	 ...
	 * <P>Note: Big-endian LSB-0 encoding.</P>
	 * @param position
	 * 			Position (n) within the packet.
	 * @return <b>value</b>
	 *         of type int.
	 ...
	 * Returns the char string converted byte-by-byte starting at the position (n) up to (n+length+1).
 	 * <P>Note: Any trailing null char will be eliminated.</P> 
	 * @param position
	 * 			Position (n) within the packet.
	 * @param length
	 * 			Length of the intended slice as int.
	...
	/**
	 * Modifies the value of the bytes starting at the position (n) by setting it to the character values passed as String. 
	 * <P>Note: The trailing null char will not be stored.</P>
	 * @param position
	 * 			Position (n) within the packet.
	 * @param text
	 * 			of type String.
	...
	public static int byteArrayToInt(byte[] data)  {
		return data[0] << 24 | (data[1] & 0xff) << 16 |
...
/**
 * end-of-velux/bridge/comm/slip/Packet.java
 */
