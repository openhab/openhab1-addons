...
import org.openhab.binding.velux.bridge.comm.json.JsonBridgeCommunicationProtocol;
...
public class JsonVeluxBridge extends VeluxBridge {
	 ...
	 * Can be accessed via  method {@link org.openhab.binding.velux.bridge.comm.json.bridgeAPI bridgeAPI}.
     *
	 */
    ...
    /**
     * Provide access to interface methods contained within {@link org.openhab.binding.velux.bridge.comm.BridgeAPI BridgeAPI}level communication with the {@link JsonVeluxBridge <b>Velux</b> bridge}.
     *
     * @return <b>bridgeAPI</b> of type {@link BridgeAPI} containing all methods being implemented for this type of bridge.
     */
     ...
     *                            from JSON.
     * @return <b>response</b> of type Object containing all resulting informations, i.e. device status, errors a.s.o. Will
     *         return
     ...
     */
    public synchronized boolean bridgeDirectCommunicate(JsonBridgeCommunicationProtocol communication, boolean useAuthentication) {
