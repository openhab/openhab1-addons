...
public class MystromClient implements IMystromClient{
	 ...
	 * @param userName The user name for the mystrom server connection.
	 * @param password The password for the mystrom server connection.
	 * @param logger The logger used to log into openhab.
	 */
