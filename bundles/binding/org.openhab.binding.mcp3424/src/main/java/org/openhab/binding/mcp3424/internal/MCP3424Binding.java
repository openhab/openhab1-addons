...
public class MCP3424Binding extends AbstractActiveBinding<MCP3424BindingProvider> implements GpioPinListenerAnalog {
	...
	public void activate(final BundleContext bundleContext, final Map<String, Object> configuration) {
		...
		logger.debug("mcp3424 activated " + this.hashCode());
		setProperlyConfigured(true);
		logger.debug("mcp3424 activated and ProperlyConfigured " + this.hashCode());
	}
...
//		logger.debug("execute() method is called!");
    ...
    protected void internalReceiveCommand(String itemName, Command newState) {
        super.internalReceiveCommand(itemName, newState);
