...
import org.openhab.binding.onewire.internal.deviceproperties.OneWireDevicePropertyBindingConfigFactory;
...
public class OneWireGenericBindingProvider extends AbstractGenericBindingProvider implements OneWireBindingProvider {
	...
	public void processBindingConfiguration(String pvContext, Item pvItem, String pvBindingConfig) throws BindingConfigParseException {
		...
		AbstractOneWireDevicePropertyBindingConfig pvDevicePropertyBindingConfig = OneWireDevicePropertyBindingConfigFactory.createOneWireDeviceProperty(pvItem, pvBindingConfig);
	 ...
	 */
	public AbstractOneWireDevicePropertyBindingConfig getBindingConfig(String pvItemName) {
		return (AbstractOneWireDevicePropertyBindingConfig) bindingConfigs.get(pvItemName);
	}
