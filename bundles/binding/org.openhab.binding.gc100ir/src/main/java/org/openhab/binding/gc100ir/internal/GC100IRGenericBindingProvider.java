 ...
 * @since 1.6.0
 */
public class GC100IRGenericBindingProvider extends
		AbstractGenericBindingProvider implements GC100IRBindingProvider {
	 ...
	 * @throws BindingConfigParseException
	 */
	private GC100BindingConfig parseBindingConfig(Item item,
			String bindingConfig) throws BindingConfigParseException {
		...
		return new GC100BindingConfig(gc100Instance, Integer.parseInt(module),
				Integer.parseInt(connector), code);
	}
	 ...
	 */
	@Override
	public String getGC100Instance(String itemname) {
		GC100BindingConfig bindingConfig = (GC100BindingConfig) bindingConfigs
				.get(itemname);
	...
	class GC100BindingConfig implements BindingConfig {
		...
		public GC100BindingConfig(String gc100Instance,
				int module, int connector, String code) {
