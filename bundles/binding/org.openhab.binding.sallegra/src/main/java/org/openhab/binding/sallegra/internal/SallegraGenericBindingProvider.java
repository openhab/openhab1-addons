...
public class SallegraGenericBindingProvider extends AbstractGenericBindingProvider implements SallegraBindingProvider {
	...
	private static Logger logger = LoggerFactory
			.getLogger(SallegraGenericBindingProvider.class);
	...
	public void processBindingConfiguration(String context, Item item,
		...
		if (bindingConfig == null || item == null) {
			logger.error(
					"invalid null input, item={}, bindingConfig={}",
					item, bindingConfig);
			return;
		}
	...
	//	SallegraBindingConfig bindingConfig = (SallegraBindingConfig) this.bindingConfigs
	//			.get(name);
