...
public class SallegraBinding extends AbstractActiveBinding<SallegraBindingProvider> implements ManagedService {
	...
	private static final Logger logger = 
		LoggerFactory.getLogger(SallegraBinding.class);
	...
	/** 
	 * the refresh interval which is used to poll values from the Sallegra
	...
	protected void execute() {
        for (SallegraBindingProvider provider : providers) {
            ...
            for (String name : names) {
                ...
                SallegraBindingConfig bindingConfig = provider
	 ...
	 */
    private void postUpdate(SallegraBindingProvider provider, SallegraBindingConfig string,
            final String value) {
