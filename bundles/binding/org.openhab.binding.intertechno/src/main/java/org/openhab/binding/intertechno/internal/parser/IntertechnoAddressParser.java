...
public interface IntertechnoAddressParser {
    ...
    /**
     * Parse the config from the given config parts. After this method was
     * called the on and off commands can be read with getCommand(ON|OFF).
     * 
     * @param addressParts
     *            String list, which contains config items like this: <name>=<value>.
