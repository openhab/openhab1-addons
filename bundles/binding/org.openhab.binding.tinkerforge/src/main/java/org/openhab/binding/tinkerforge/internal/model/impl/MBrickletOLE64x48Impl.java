 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletOLE64x48Impl#getIpConnection
 * <em>Ip Connection</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletOLE64x48Impl#getConnectedUid
 ...
 * </li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MBrickletOLE64x48Impl#getDeviceIdentifier
...
public class MBrickletOLE64x48Impl extends MinimalEObjectImpl.Container implements MBrickletOLE64x48 {
    ...
    @Override
    public void clear() {
        clear((short) 0, (short) 63, (short) 0, (short) 5);
    }
    ...
    public void clear(short columnFrom, short columnTo, short rowFrom, short rowTo) {
        ...
        if (rowFrom < 0 || rowFrom > maxLine) {
            logger.error("start row must have a value from 0 to 5");
            return;
        }
        if (rowTo < 0 || rowTo > maxLine) {
            logger.error("end row must have a value from 0 to 5");
            return;
        }
        try {
