 ...
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MNFCIDImpl#getDeviceType <em>Device Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MNFCIDImpl extends MinimalEObjectImpl.Container implements MNFCID {
     ...
     * @ordered
     */
    protected static final String DEVICE_TYPE_EDEFAULT = "id";
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            ...
            case ModelPackage.MNFCID__DEVICE_TYPE:
