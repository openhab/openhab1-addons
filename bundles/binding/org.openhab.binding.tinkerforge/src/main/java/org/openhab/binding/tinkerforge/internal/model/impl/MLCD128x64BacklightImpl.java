...
import com.tinkerforge.BrickletLCD128x64.DisplayConfiguration;
import com.tinkerforge.NotConnectedException;
import com.tinkerforge.TimeoutException;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>MLCD12 8x64 Backlight</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getSwitchState <em>Switch
 * State</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getLogger
 * <em>Logger</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getUid <em>Uid</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#isPoll <em>Poll</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getEnabledA <em>Enabled
 * A</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getSubId <em>Sub Id</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getMbrick
 * <em>Mbrick</em>}</li>
 * <li>{@link org.openhab.binding.tinkerforge.internal.model.impl.MLCD128x64BacklightImpl#getDeviceType <em>Device
 * Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MLCD128x64BacklightImpl extends MinimalEObjectImpl.Container implements MLCD128x64Backlight {
    /**
    ...
    protected EClass eStaticClass() {
        return ModelPackage.Literals.MLCD12_8X64_BACKLIGHT;
    }
    ...
    public NotificationChain basicSetMbrick(MBrickletLCD128x64 newMbrick, NotificationChain msgs) {
        msgs = eBasicSetContainer((InternalEObject) newMbrick, ModelPackage.MLCD12_8X64_BACKLIGHT__MBRICK, msgs);
        return msgs;
    }
    ...
    public void init() {
        ...
        logger = LoggerFactory.getLogger(MLCD128x64BacklightImpl.class);
    }
    ...
    public void fetchSwitchState() {
        ...
        try {
            DisplayConfiguration config = getMbrick().getTinkerforgeDevice().getDisplayConfiguration();
            switchValue = config.backlight > 0 ? OnOffValue.ON : OnOffValue.OFF;
        } catch (TimeoutException e) {
            TinkerforgeErrorHandler.handleError(this, TinkerforgeErrorHandler.TF_TIMEOUT_EXCEPTION, e);
        } catch (NotConnectedException e) {
            TinkerforgeErrorHandler.handleError(this, TinkerforgeErrorHandler.TF_NOT_CONNECTION_EXCEPTION, e);
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ModelPackage.MLCD12_8X64_BACKLIGHT__SWITCH_STATE:
                return getSwitchState();
            case ModelPackage.MLCD12_8X64_BACKLIGHT__LOGGER:
                return getLogger();
            case ModelPackage.MLCD12_8X64_BACKLIGHT__UID:
                return getUid();
            case ModelPackage.MLCD12_8X64_BACKLIGHT__POLL:
                return isPoll();
            case ModelPackage.MLCD12_8X64_BACKLIGHT__ENABLED_A:
                return getEnabledA();
    ...
    public void eSet(int featureID, Object newValue) {
        switch (featureID) {
            ...
            case ModelPackage.MLCD12_8X64_BACKLIGHT__SUB_ID:
                ...
                return;
            case ModelPackage.MLCD12_8X64_BACKLIGHT__MBRICK:
                setMbrick((MBrickletLCD128x64) newValue);
                return;
        }
    ...
    public void eUnset(int featureID) {
        switch (featureID) {
            ...
            case ModelPackage.MLCD12_8X64_BACKLIGHT__SUB_ID:
                ...
                return;
            case ModelPackage.MLCD12_8X64_BACKLIGHT__MBRICK:
                setMbrick((MBrickletLCD128x64) null);
                return;
        }
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == MLCD128x64SubDevice.class) {
            switch (derivedFeatureID) {
                default:
                    return -1;
            }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MBASE_DEVICE__LOGGER:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT__LOGGER;
                case ModelPackage.MBASE_DEVICE__UID:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT__UID;
                case ModelPackage.MBASE_DEVICE__POLL:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT__POLL;
                case ModelPackage.MBASE_DEVICE__ENABLED_A:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT__ENABLED_A;
                default:
                    return -1;
            }
        }
        if (baseClass == MSubDevice.class) {
            switch (baseFeatureID) {
                case ModelPackage.MSUB_DEVICE__SUB_ID:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT__SUB_ID;
                case ModelPackage.MSUB_DEVICE__MBRICK:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT__MBRICK;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == MBaseDevice.class) {
            switch (baseOperationID) {
                case ModelPackage.MBASE_DEVICE___INIT:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT___INIT;
                case ModelPackage.MBASE_DEVICE___ENABLE:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT___ENABLE;
                case ModelPackage.MBASE_DEVICE___DISABLE:
                    return ModelPackage.MLCD12_8X64_BACKLIGHT___DISABLE;
                default:
                    return -1;
            }
        }
    ...
    public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
        switch (operationID) {
            case ModelPackage.MLCD12_8X64_BACKLIGHT___INIT:
                init();
                return null;
            case ModelPackage.MLCD12_8X64_BACKLIGHT___ENABLE:
                enable();
                return null;
            case ModelPackage.MLCD12_8X64_BACKLIGHT___DISABLE:
                disable();
                return null;
            case ModelPackage.MLCD12_8X64_BACKLIGHT___TURN_SWITCH__ONOFFVALUE:
                turnSwitch((OnOffValue) arguments.get(0));
                return null;
            case ModelPackage.MLCD12_8X64_BACKLIGHT___FETCH_SWITCH_STATE:
                fetchSwitchState();
                return null;
        }
