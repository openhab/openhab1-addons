...
public class MBrickdImpl extends MinimalEObjectImpl.Container implements MBrickd {
    ...
    private void addDevice(String uid, String connectedUid, int deviceIdentifier) {
        ...
        if (getDevice(uid) != null) {
            ...
            } else if (deviceIdentifier == BrickletOLED128x64V2.DEVICE_IDENTIFIER) {
                logger.debug("addDevice BrickletOLED128x64V2");
                mDevice = factory.createMBrickletOLED128x64V2();
                mDevice.setDeviceIdentifier(BrickletOLED128x64V2.DEVICE_IDENTIFIER);
            ...
            } else if (deviceIdentifier == BrickletRGBLEDButton.DEVICE_IDENTIFIER) {
                logger.debug("addDevice BrickletRGBLEDButton");
                mDevice = factory.createMBrickletRGBLEDButton();
                mDevice.setDeviceIdentifier(BrickletRGBLEDButton.DEVICE_IDENTIFIER);
            } else if (deviceIdentifier == BrickletNFC.DEVICE_IDENTIFIER) {
                logger.debug("addDevice BrickletNFC");
                mDevice = factory.createMBrickletNFC();
                mDevice.setDeviceIdentifier(BrickletNFC.DEVICE_IDENTIFIER);
            }
            if (mDevice != null) {
