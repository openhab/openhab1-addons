		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModelGroupItemAccess().getActiveStateAlternatives_2_3_2_0_0(), "rule__ModelGroupItem__ActiveStateAlternatives_2_3_2_0_0");
					put(grammarAccess.getModelGroupItemAccess().getPassiveStateAlternatives_2_3_2_2_0(), "rule__ModelGroupItem__PassiveStateAlternatives_2_3_2_2_0");
					...
					put(grammarAccess.getModelGroupItemAccess().getGroup_2_3(), "rule__ModelGroupItem__Group_2_3__0");
					put(grammarAccess.getModelGroupItemAccess().getGroup_2_3_2(), "rule__ModelGroupItem__Group_2_3_2__0");
					...
					put(grammarAccess.getModelGroupItemAccess().getFunctionAssignment_2_3_0(), "rule__ModelGroupItem__FunctionAssignment_2_3_0");
					put(grammarAccess.getModelGroupItemAccess().getActiveStateAssignment_2_3_2_0(), "rule__ModelGroupItem__ActiveStateAssignment_2_3_2_0");
					put(grammarAccess.getModelGroupItemAccess().getPassiveStateAssignment_2_3_2_2(), "rule__ModelGroupItem__PassiveStateAssignment_2_3_2_2");
